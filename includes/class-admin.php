...
class Dmm_Admin {
    ...
    function dmm_admin_notice__warning() {
        ...
        <div class="notice notice-warning is-dismissible">
            <p><?php _e('In order for the plugin "Donate with Mollie" to function properly, it is necessary to enable permalinks in your <a href="options-permalink.php">Wordpress settings</a>.', DMM_TXT_DOMAIN); ?></p>
        </div>
        <?php
    }
    ...
    public function dmm_export_donations()
    {
        ...
        fputcsv($output, array(
            ...
            esc_html_e('Recurring payment', DMM_TXT_DOMAIN),
        ...
        foreach ($donations as $donation)
        {
            fputcsv($output, array(
                ...
                $donation->customer_id ? __('Yes', DMM_TXT_DOMAIN) : __('No', DMM_TXT_DOMAIN),
        ...
        <div class="wrap">
            ...
            <table class="widefat fixed striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <th class="column-empty"></th>
                        <th class="column-a" scope="row"><strong><?php esc_html_e('Recurring payment', DMM_TXT_DOMAIN);?></strong></th>
                        <td class="column-b"><?php echo esc_html($donation->customer_id ? __('Yes', DMM_TXT_DOMAIN) : __('No', DMM_TXT_DOMAIN));?></td>
                    </tr>
                    <tr>
                        <th class="column-empty"></th>
                ...
                <tbody>
                    ...
                    <tr valign="top">
                        ...
                        <td class="forminp">
                            ...
                            <small><?php printf(esc_html__('You can use: %s', DMM_TXT_DOMAIN), '{id} {name} {email} {project} {amount} {company} {interval}');?></small>
                        </td>
                    </tr>
                    <tr valign="top">
                        <th scope="row" class="titledesc">
                    ...
                    <tr valign="top">
                        <th scope="row" class="titledesc">
                            <label><?php esc_html_e('Rights donations', DMM_TXT_DOMAIN);?></label>
                        </th>
                        <td class="forminp">
                            <select name="dmm_rights_donations">
                                <option value="edit_dashboard"><?php esc_html_e('Administrator', DMM_TXT_DOMAIN);?></option>
                                <option value="edit_pages" <?php echo (get_option('dmm_rights_donations') == 'edit_pages' ? 'selected' : '');?>><?php esc_html_e('Editor', DMM_TXT_DOMAIN);?></option>
                                <option value="edit_posts" <?php echo (get_option('dmm_rights_donations') == 'edit_posts' ? 'selected' : '');?>><?php esc_html_e('Author', DMM_TXT_DOMAIN);?></option>
                            </select>
                        </td>
                    </tr>
                    <tr valign="top">
                        <th scope="row" class="titledesc">
                            <label><?php esc_html_e('Rights subscriptions', DMM_TXT_DOMAIN);?></label>
                        </th>
                        <td class="forminp">
                            <select name="dmm_rights_subscriptions">
                                <option value="edit_dashboard"><?php esc_html_e('Administrator', DMM_TXT_DOMAIN);?></option>
                                <option value="edit_pages" <?php echo (get_option('dmm_rights_subscriptions') == 'edit_pages' ? 'selected' : '');?>><?php esc_html_e('Editor', DMM_TXT_DOMAIN);?></option>
                                <option value="edit_posts" <?php echo (get_option('dmm_rights_subscriptions') == 'edit_posts' ? 'selected' : '');?>><?php esc_html_e('Author', DMM_TXT_DOMAIN);?></option>
                            </select>
                        </td>
                    </tr>
                </tbody>
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                ...
                <?php if (get_option('dmm_recurring')) {
                    ...
                    <tr valign="top">
                        <th scope="row" class="titledesc">
                            <label><?php esc_html_e('Default interval', DMM_TXT_DOMAIN);?></label>
                        </th>
                        <td class="forminp">
                            <select name="dmm_default_interval">
                                <option value="one"><?php esc_html_e('One-time donation', DMM_TXT_DOMAIN);?></option>
                                <option value="month" <?php echo get_option('dmm_default_interval') == 'month' ? 'selected' : '';?>><?php esc_html_e('Monthly', DMM_TXT_DOMAIN);?></option>
                                <option value="quarter" <?php echo get_option('dmm_default_interval') == 'quarter' ? 'selected' : '';?>><?php esc_html_e('Each quarter', DMM_TXT_DOMAIN);?></option>
                                <option value="year" <?php echo get_option('dmm_default_interval') == 'year' ? 'selected' : '';?>><?php esc_html_e('Annually', DMM_TXT_DOMAIN);?></option>
                            </select>
                        </td>
                    </tr>
                <?php } ?>
